                ...
                if obj is not None:
                    if obj.completed == True:
                        ...
                        if a is None:
                            ...
                            recent_obj = db_session.query(db_manager.ProductListing).filter(db_manager.ProductListing.duplicate_set == a.duplicate_set).order_by(desc('date_completed')).first()
