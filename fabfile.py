...
def setup(ctx):
    ...
    for _, conn in enumerate(ctx.CONNS):
        ...
        command = f'python3 scrapingtool/archive.py --process_archived_pids --categories "headphones" --instance_id {instance_number} --num_instances {num_instances} --num_threads 5 && systemctl poweroff'
